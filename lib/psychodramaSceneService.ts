...
请返回JSON格式（聚焦用户内心！）：
{
  ...
  **格式要求：必须明确性别和年龄！**
  ...
  "innerMonologue": "用户内心独白（80-120字中文）：🚨🚨🚨 第一优先级：用户本次实际说的情绪和想法！
  - 用户说'害怕、恐惧' → 必须写恐惧感受：'心跳加速，感到害怕和不安...'
  - 用户说'想男朋友、孤独' → 必须写思念：'独自面对这一切，渴望他在身边陪伴...'
  - 用户说'笑死了、讽刺' → 才可以写批判和嘲讽
  - 用户说'发现Noema杂志' → 必须写发现和思考：'原来还有这样的杂志...质量这么高...智性内容...怎么盈利的...'
  - 性格特质只作为10%修饰，不能主导！
  例如（害怕情绪）：'心跳还在砰砰跳，半夜雷声太响了...独自一人感到害怕...好想他能在身边陪我...'
  例如（讽刺情绪）：'我就用6块钱解决了，你在这吹什么伟大...笑死了...'
  例如（发现杂志）：'这是什么杂志...质量这么高...还有这么智性的内容...他们怎么盈利的...真好奇...'",
  
  "surfaceVsInner": "表面vs内心对比（60-80字中文）：⚠️ 基于用户本次实际说的情绪和想法！
  - 用户说'害怕但起来检查' → '表面：起身检查窗户，动作看似平静...内心：心跳加速，感到恐惧和不安'
  - 用户说'想男朋友但没说出来' → '表面：独自面对...内心：渴望他的陪伴'
  - 用户说'发现Noema杂志' → '表面：浏览网页，看似平静...内心：被内容震撼，思考商业模式'
